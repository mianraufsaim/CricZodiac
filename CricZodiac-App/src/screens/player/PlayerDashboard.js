...
import {
  ...
  RefreshControl, Image, Platform, StatusBar, TouchableOpacity,
} from 'react-native';
...
const getStyles = (COLORS) => StyleSheet.create({
  ...
  pageHeader:     { paddingTop: Platform.OS === 'ios' ? 54 : (StatusBar.currentHeight || 24) + 10, paddingHorizontal: 20, paddingBottom: 8, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' },
