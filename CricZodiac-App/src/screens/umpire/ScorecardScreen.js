...
const ScorecardScreen = ({ navigation, route }) => {
  ...
  // ── State ────────────────────────────────────────────
  // Admin flow: array of { innings, batting, bowling }
  ...
  const [scoreTab,    setScoreTab]    = useState('batting'); // 'batting' | 'bowling'
  ...
  // ── Active innings data (admin flow) ─────────────────
