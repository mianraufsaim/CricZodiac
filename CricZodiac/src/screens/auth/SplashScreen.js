...
const getStyles = (COLORS) => StyleSheet.create({
  ...
  tagline:        { color: COLORS.gold, fontSize: 14, fontWeight: '800', letterSpacing: 2, marginHorizontal: 10 },
  brand:          { color: COLORS.lightGray, fontSize: 13, fontWeight: '700', letterSpacing: 1, marginTop: 4 },
