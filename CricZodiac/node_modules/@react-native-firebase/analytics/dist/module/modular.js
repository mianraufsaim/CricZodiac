 ...
 * Returns an Analytics instance for the given app.
 */
export function initializeAnalytics(app, _options) {
  return getApp(app.name).analytics();
}
 ...
 */
export function logTransaction(analytics, transaction_id) {
  if (Platform.OS !== 'ios') {
    return Promise.reject(new Error('logTransaction is only available on iOS'));
  }
  return analytics.native.logTransaction(transaction_id);
}
 ...
 */
export function initiateOnDeviceConversionMeasurementWithHashedEmailAddress(analytics, hashedEmailAddress) {
 ...
 */
export function initiateOnDeviceConversionMeasurementWithHashedPhoneNumber(analytics, hashedPhoneNumber) {
...
export function settings(_options) {
